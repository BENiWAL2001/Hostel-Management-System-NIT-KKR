...
<body>
    ...
    <div class="main">
        <div class="dashboard">
            <a href="upload_notification.php?id=<?php echo $user_id ?>">
                <div class="card text-center">
                    <div class="icon" style="color:#01bf71; padding-bottom: 30px;"><i class="fa-solid fa-cloud-arrow-up fa-beat-fade fa-2xl"></i></div>
                    <h2>Upload Notification</h2>
                    <p class="par">Upload new notification.</p>
                </div>
            </a>
            <a href="view_notification.php?id=<?php echo $user_id ?>">
                <div class="card text-center">
                    ...
                    <p class="par">View all notifications.</p>
                </div>
            </a>
        </div>
    </div>
